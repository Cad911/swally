...
(function() {
  window.ourApp.directive('ngTapTap', function() {
    return function(scope, element, attrs) {
      $(element).hammer().on('tap', function(e) {
        return scope.$apply(attrs.ngTapTap);
      });
      return true;
    };
  });
  ...
  window.ourApp.directive('noScrollMobile', function() {
    return function(scope, element, attrs) {
      ...
      scope.$on('show-mini-game', function() {
        return $('.table-main-content').css('position', 'fixed');
      });
      scope.$on('hide-mini-game', function() {
        return $('.table-main-content').css('position', 'relative');
      });
      return true;
    };
  });
